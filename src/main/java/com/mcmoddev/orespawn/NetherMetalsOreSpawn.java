...
**/
		...
		if (Loader.isModLoaded("basemetals")) {
			logic.getDimension(-1)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 4, 10, 0,  32)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 4,  10, 0,  32)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 12,  20, 0,  96)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 12,  20, 0,  96)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 4,  10, 0,  32)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 4,  10, 0,  96)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 4,  10, 0,  32)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 8,  10, 0,  32)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 12,  20, 0,  96)
					.addOre(MaterialsNetherOre.getMaterialByName("antimony").oreNether.getDefaultState(), 8, 8,  12, 0,  96);
		}
/**
		//Modern Metals
