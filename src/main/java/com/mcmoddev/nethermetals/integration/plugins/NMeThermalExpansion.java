...
@MMDPlugin(
		...
		pluginId = NMeThermalExpansion.PLUGIN_MODID,
		versions = NMeThermalExpansion.PLUGIN_MODID + "@(,5.3.12.17];")
public final class NMeThermalExpansion extends ThermalExpansion implements IIntegration {
