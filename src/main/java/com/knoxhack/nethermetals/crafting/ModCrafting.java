...
//			GameRegistry.addSmelting(ModBlocks.netherantimonyOre, new ItemStack(BmBlocks.antimony_ore, 2), 1.0f);	// Not supported in BM 1.8.0
//			GameRegistry.addSmelting(ModBlocks.netherbismuthOre, new ItemStack(BmBlocks.bismuth_ore, 2), 1.0f);		// Not supported in BM 1.8.0
...
//			GameRegistry.addSmelting(ModBlocks.netherplatinumOre, new ItemStack(BmBlocks.platinum_ore, 2), 1.0f);	// Not supported in BM 1.8.0
